...
const HeroSection = () => (
  <section className="relative min-h-screen flex items-center">
    ...
    <div className="absolute inset-0">
      <img
        src={heroImage}
        alt="Children physical education and sports training program by SportSpark Sports Foundation"
    ...
    <div className="relative z-10 container-wide pt-32 pb-20">
      <div className="max-w-2xl">
        ...
        >
          SportSpark Sports Foundation aims to be India's Admirable Physical Education and Sports Organization. 
          SportSpark is dedicated to creating, implementing, and evaluating research-based programs that 
          promote lifelong wellness. SportSpark is committed to outstanding customer satisfaction through 
        ...
        <motion.p
          ...
          className="text-base md:text-lg text-background/70 mb-8 max-w-2xl text-justify"
        >
          SportSpark Sports Foundation collaborates with schools across India to implement best-in-class physical education. We provide certified on-site trainers and age-appropriate equipment kits to enhance children's fitness and academic performance.
        </motion.p>
          ...
          {programs.map((program, i) => (
            <Link key={i} to="/programs">
              ...
              >
                <img
                  src={program.image}
                  alt={`${program.name} - SportSpark physical education for ${program.level}`}
...
const WhyChooseUsSection = () => {
  const reasons = [
    "Provides certified on-site trainers directly to school campuses",
    "Supplies age-appropriate sports kits and equipment for all grades",
    "Replaces traditional school PT with engaging, research-based programs",
    "Sparks early interest and enthusiasm for physical wellness",
    "98% of children identify “FUN” as the key factor in our programs",
    "Nurtures lifelong health habits and teamwork from KG to Class 12",
    "Supports school management with periodical reports and professional coaching",
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-background/80 mb-8 max-w-2xl text-justify">
              SportSpark bridges the gap in school physical education by providing dedicated expert trainers and specialized sports equipment, making fitness an integral part of the school experience nationwide.
            </p>
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              <img
                src={found1}
                alt="SportSpark Sports Foundation certified sports coach training students"
                className="w-full h-64 object-cover rounded-2xl"
              />
              <img
                src={found2}
                alt="Professional physical education trainer in school sports program"
...
const TestimonialsSection = () => {
  const testimonials = [
    {
      quote: "SportSpark Sports Foundation's PE programs have significantly improved our students' physical fitness and overall development. The curriculum is well-structured and age-appropriate.",
    ...
    {
      quote: "The professional development and support provided by SportSpark has helped our teachers deliver quality physical education effectively.",
      author: "Mrs. Lakshmi",
...
const Index = () => {
  return (
    <Layout>
      <SEO 
        title="Best School Sports Trainers & Physical Education in India"
        description="Revolutionizing physical education across India. We provide certified on-site trainers and specialized sports kits for schools from KG to Class 12."
        schema={{
          "@context": "https://schema.org",
          "@type": "WebSite",
          "name": "SportSpark Sports Foundation",
          "url": "https://www.sportseducate.com"
        }}
      />
      <HeroSection />
      <HighlightsSection />
