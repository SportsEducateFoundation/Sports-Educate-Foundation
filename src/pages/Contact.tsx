...
const Contact = () => {
  ...
  const addresses = [
    {
      ...
      mapTitle: "SportSpark Sports Foundation - Registered Office, Virudhunagar",
    },
    {
      ...
      mapTitle: "SportSpark Sports Foundation - Coimbatore Office",
    },
  ];
  ...
  return (
    <Layout>
      <SEO 
        title="Contact Us | Hire Professional Sports Trainers for Schools"
        description="Connect with SportSpark Sports Foundation for school sports collaborations, physical education trainer deployment, and sports equipment kits across India."
        schema={{
