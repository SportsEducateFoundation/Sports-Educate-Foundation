...
const About = () => {
  ...
  const timeline = [
    { year: "2026", title: "Foundation", desc: "SportSpark Sports Foundation established with a vision to revolutionize physical education in schools" },
  ];

  return (
    <Layout>
      <SEO 
        title="About our Foundation | Certified Schools Sports Partners"
        description="Learn about SportSpark Sports Foundation's mission to revolutionize school sports in India through expert coaching and specialized kits."
        schema={{
          ...
          "itemListElement": [{
            ...
            "position": 1,
            "name": "Home",
            "item": "https://www.sportseducate.com"
          },{
            "@type": "ListItem",
            "position": 2,
            "name": "About Us",
            "item": "https://www.sportseducate.com/about"
          }]
        }}
      />
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-background/70 mb-6 text-justify">
                SportSpark Sports Foundation collaborates with schools to implement best-in-class physical education and sports programs. These programs significantly enhance children's fitness levels and contribute greatly to their overall development, including personal, physical, and social skills.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed text-justify">
                SportSpark sports foundation  Aim to be India’s Admirable Physical Education and Sports Organization. SportSpark is dedicated to creating, implementing, and evaluating research-based programs that promote lifelong wellness. SportSpark is committed to outstanding customer satisfaction through timely delivery and exceptional service.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="section-padding bg-muted">
        <div className="container-wide">
          <SectionHeader
            ...
            subtitle="The strong foundation of SportSpark Sports Foundation that defines who we are and sets us apart"
          />
