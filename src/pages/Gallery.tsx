...
const Gallery = () => {
  ...
  return (
    <Layout>
      <SEO 
        title="Sports Action Gallery | PE Training Sessions in Schools"
        description="Explore action shots from our physical education programs, teacher training workshops, and inter-school sports competitions across India."
        keywords="school sports gallery, PE training photos, sports education action shots, teacher training sessions, school sports events India"
      />
      {/* Hero Section */}
