...
const sportsPrograms = [
  {
    ...
    description: "SportSpark Sports Foundation Sports program covers all sports starting from Football, Cricket, Tennis, Baseball, Basketball, Rugby, Frisbee, Volleyball etc. The program is developed specifically to impart coaching across multiple age groups. SportSpark provide coaching from basic to intermediate and advance level.",
...
const Programs = () => {
  return (
    <Layout>
      <SEO 
        title="School Sports Programs & Physical Education Curriculum"
        description="Comprehensive sports education programs from KG to Class 12. We provide on-site experts and age-appropriate kits to schools nationwide."
        schema={{
          "@context": "https://schema.org",
          "@type": "Service",
          "serviceType": "Physical Education Programs",
          "provider": {
            "@type": "Organization",
            ...
            {physicalEducationPrograms.map((program, i) => (
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  <img
                    src={program.image}
                    alt={`${program.name} - SportSpark Sports foundation physical activity for ${program.ageGroup}`}
            ...
            {sportsPrograms.map((program, i) => (
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  <img
                    src={program.image}
                    alt={`${program.name} - Professional sports coaching and event management for ${program.ageGroup}`}
                    className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
                  />
                  <div className="absolute top-4 right-4 px-3 py-1 rounded-full bg-accent text-accent-foreground text-xs font-semibold">
                    {program.ageGroup}
